...
class KakfaTopologiTest {
    ...
    fun test_skjema_is_not_automatic_expect_to_manuell() {
        ...
        enrichedKafkaEvent.journalpost = mockJournalpost("585308762", "ABC", "SYK", "M")
    ...
    fun test_toManuell_flag_from_enricher_is_true_expect_to_manuell() {
        val event = KafkaEvent(UUID.randomUUID().toString(), "Mottatt", 585308762, "SYK", "NAV_NO", "M")
        val enrichedKafkaEvent = EnrichedKafkaEvent(event)
        enrichedKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 06-04.04", "SYK", "M")
    ...
    fun test_toManuell_flag_is_true_expect_to_manuell() {
        val event = KafkaEvent(UUID.randomUUID().toString(), "Mottatt", 585308762, "SYK", "NAV_NO", "M")
        val enrichedKafkaEvent = EnrichedKafkaEvent(event)
        enrichedKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 08-07.04D", "SYK", "M")
        val generellKafkaEvent = EnrichedKafkaEvent(event)
        generellKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 08-07.04D", "SYK", "M")
    ...
    fun test_toManuell_flag_from_journafoering_is_true_expect_to_manuall() {
        ...
        postJournalfoeringKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 08-07.04D", "SYK", "M")
    ...
    fun test_success_journafoering_expect_not_to_manuall() {
        ...
        enrichedKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 08-07.04D", "SYK", "M")
        val postJournalfoeringKafkaEvent = EnrichedKafkaEvent(event)
        postJournalfoeringKafkaEvent.journalpost = mockJournalpost("585308762", "NAV 06-04.04", "SYK", "M")
